...
const cases = [
  {
    ...
    content: (
      <>
        ...
        <span className="text-primary">季度GMV提升约10%</span>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        ，存在博客文章、论坛帖子、问答社区、知识付费商品等多种类型内容需要提升搜索效果，并且需要对多种内容合理融合成一个综合的搜索结果，以CTR(点击率)为优化目标，使用通智搜索后，通过意图识别阶段对分词、同义词、纠错、实体识别、词权重等问题的优化，通过对多路召回和各路召回源融合策略的优化，通过综合排序的优化，最终CTR从3.6%
        <span className="text-primary">提升到5.3%</span>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <span className="text-primary">准确匹配率达到了93%</span>{" "}
        ，用户体验上了一个台阶
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <span className="text-primary">停留时长提升约16%</span>
      </>
    ),
  },
];
